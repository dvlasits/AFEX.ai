...
The sequence is '%SEQ%' and it is similar to commonly found '%SEQ2%'. Mention only the second sequence in your answer. It's fine if your answer is wrong,
...
4. A similar motive `DFGK` is common for kinases"""
    ...
    msg = msg.replace("%SEQ%", seq).replace("%SEQ2%", seq2)
